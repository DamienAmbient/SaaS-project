    ...
    <Card className="max-w-xl w-full">
      <div>
        ...
        <div className="mt-1 relative">
          <Input type="password" value={apiKey} readOnly></Input>
          <div className="absolute space-x-0.5 inset-y-0 right-0 flex items-center">
            ...
            >
              {copySuccess ? (
                <CheckIcon className="size-4 text-brand-900"></CheckIcon>
              ) : (
                <ClipboardIcon className="size-4 text-brand-900"></ClipboardIcon>
              )}
            </Button>
          </div>
        </div>
