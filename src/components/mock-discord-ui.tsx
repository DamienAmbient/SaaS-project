          ...
          <div className="px-2 mb-4">
            ...
            <div className="my-1 space-y-px">
              {[...Array(4)].map((_, i) => (
                <div
                  key={i}
                  className="flex items-center px-22 py-1.5 rounded text-gray-600 cursor-not-allowed"
                >
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="p-4">
          <div className="flex items-center bg-[#40444b] rounded-lg p-1">
            <PlusCircle className="mx-3 text-[#b9bbbe] hover:text-white cursor-not-allowed"></PlusCircle>
            <input
              readOnly
              type="text"
            ...
            <div className="flex items-center space-x-3 mx-3 text-[#b9bbbe]">
              <Gift className="size-5 hover:text-white cursor-not-allowed hidden sm:block"></Gift>
              <Sticker className="size-5 hover:text-white cursor-not-allowed hidden sm:block"></Sticker>
              <Smile className="size-5 hover:text-white cursor-not-allowed hidden sm:block"></Smile>
            </div>
          </div>
        </div>
      </div>
